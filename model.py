...
if __name__ == '__main__':
    ...
    if ask != 'y':
        ...
        ax.set_xlabel("Depth (cm)", fontsize="20")
        ax.set_xticks(ticks=[0, 15], labels=["0", "15"], fontsize=20)
        ax.set_yticks(ticks=[0, 1200], labels=["0", "1200"], fontsize=20)
        ax.set_ylabel("Force X (N)", fontsize="20")
        ax.set(xlim=[0,15], ylim=[0, 1200])

        plt.savefig('big_fig/cohesion_big_fig.png')
        ...
        plt.savefig('big_fig/density_big_fig.png')
        ...
        ax.set_ylabel("Force X (N)", fontsize="20")
        ax.set(xlim=[0,15], ylim=[0, 1200])
        plt.savefig('big_fig/friction_big_fig.png')
        ...
        ax.set_ylabel("Force X (N)", fontsize="20")
        ax.set(xlim=[0,15], ylim=[0, 1200])
        plt.savefig('big_fig/angle_big_fig.png')
